...
import Avatar from "../assets/findImage.png"
                ...
                <div className="w-full px-5 xl:px-[24%]">
                    ...
                    <div className="justify-center flex mx-auto gap-44 xl:gap-52 -mt-10">
                        <div onClick={() => goToPage("/settings")} >
                            <button className="justify-start cursor-pointer text-pinkLight text-xl xl:text-5xl p-2 rounded-full  border-2 xl:border-4 border-pinkLight/80 hover:text-white hover:bg-pinkLight "
                            >
                                <MdSettingsSuggest />
                            </button>
                        ...
                        <div onClick={() => goToPage("/editprofile")}>
                            <button className="justify-start text-pinkLight text-xl xl:text-5xl p-2 rounded-full border-2 xl:border-4 border-pinkLight/80 hover:text-white hover:bg-pinkLight"
                            >
                                <TiEdit />
                            </button>
                    ...
                    <div className="justify-center flex mx-auto -mt-6 xl:-mt-12">
                        <div onClick={() => goToPage("/verifyprofile")}>
                            ...
                            <button className="justify-start text-xl text-green-500 xl:text-5xl p-2 rounded-full border-2 xl:border-4 border-green-500/80 hover:green-500"
                            >
                                <GiCheckMark />
                            </button>
