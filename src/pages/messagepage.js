    ...
    return (
        <div>
            ...
            <div className='w-full h-full min-h-[calc(100vh-186px)] bg-cover px-5 py-14 bg-[#FFFBFE]'>
                <div className='w-full md:w-[500px] lg:w-[900px] mx-auto xl:h-[700px] bg-white rounded-xl border-[0.5px] border-black/20 '>
                    ...
                    <div className=''>
                        <div className='w-full hidden lg:flex text-start'>
                            <div className='w-full lg:w-1/3 overflow-y-auto min-h-[620px] border-r-[0.1px] border-black/10'>
