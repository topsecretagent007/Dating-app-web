...
import MatchesPage from "../notificationalert/matches";
import AlertsPage from "../notificationalert/alrets";
import LikesPage from "../notificationalert/likes";

export default function Notification() {
    const [page, setPage] = useState("matches");

    return (
        <div className="w-full h-full min-h-screen bg-cover px-5 pt-28 sm:px-[10%] md:px-[18%] lg:px-[24%] xl:px-[30%] xl:pt-40 bg-[#f1f1f1] py-48" >
