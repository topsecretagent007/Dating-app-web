...
export default function DeleteMessage({ deleteMessageModal }) {
    ...
    return (
        <>
            ...
            <div className="w-full lg:flex gap-2">
                <button onClick={deleteMessageModal} className="w-5/6 xl:w-2/3 px-6 py-3 text-pinkLight border-2 border-pinkLight hover:bg-pinkLight rounded-xl  mx-auto flex justify-center items-center my-3 hover:text-white gap-1">
