...
export default function ContactModal({ text, onCloseModal }) {
    ...
    return (
        <>
            ...
            <div className="p-2 rounded-full text-pinkLight text-xl absolute justify-center flex top-0 right-0 transform translate-x-1/2 -translate-y-1/2 cursor-pointer bg-white">
